...
<div class="package-inner-page">
            ...
            <div class="row g-0 package-inner-banner">
                ...
                <div class="col-lg-4 col-md-12 p-3 position-relative package-inner-title">
                    <div class="card-body">
                        ...
                        <h3 class="card-title fw-bold mb-3" v-else-if="packageData != null">
                            {{ packageData.no_of_day }}-Day {{ packageData.title }}
                        </h3>
                        <h6 class="card-title">
                            <span class="fa fa-location-arrow mx-2"></span> Cancellation Up to 24 Hrs
                        </h6>
                        <h6 class="card-title">
                            <span class="fa fa-location-arrow mx-2"></span> Only 5% Advance Payment
                        </h6>
                        <h6 class="card-title">
                            <span class="fa fa-location-arrow mx-2"></span> Can be customized
                        </h6>
                        <h6 class="card-title">
                            <span class="fa fa-location-arrow mx-2"></span> Guaranteed Departure
                        </h6>
                        <h6 class="card-title">
                            <span class="fa fa-location-arrow mx-2"></span> Get Visa On Arrival (Available)
                        </h6>
                    </div>
                    <div class="price-rate p-3">
                        ...
                        <div class="p-3" v-else>
                            ...
                            <button class="btn btn-danger mobile mt-2" @click="getQuoteNow">Get Free Quote Now
                          ...
                          packageData.getting_there.end_city
                            ...
                            <div>
                                <div class="p-3" v-if="packageData != null">
                                    ...
                                    <div class="itinery mt-5" v-for="(item, index6) in packageData.day" v-bind:key="'E' + index6">
                                        <div class="position-relative" v-if="item.image_url != null">
                                            <img :src="'http://operators.safari-trek-beach.com' + item.image_url" class="w-100" style="min-height: 170px;" />
    ...
    <div class="get-quote-mobile w-100 text-center shadow-lg">
        <button class="btn btn-danger my-3" @click="getQuoteNow">Get a Free Quote Now
            <span class="fa fa-angle-right ms-2"></span>
        </button>
    </div>
</div>
