            ...
            <div class="row">
                        ...
                        <div class="row gx-0 mobile-filter-traveler">
                            ...
                            >
                                ...
                                >
                                    ...
                                    <div
                                        class="w-100 px-2"
                                        @click="showWhereToDropdown(true)"
                                    >
                                        <input
                            ...
                            >
                                ...
                                >
                                    ...
                                    <span
                                        v-else
                                        class="fa fa-times-circle-o invisible"
                                    ></span>
                                </div>
                            </div>
                            <div
                            ...
                            >
                                ...
                                >
                                    <div
                                        class="bg-warning text-white p-2 text-center"
                                    >
                                        Travelers
                                        <span
                                            class="fa fa-times-circle-o"
                                    ...
                                    >
                                        <div>
                                            <strong>Child</strong>: (0~15 years)
                                        </div>
                                        <div>
                                            <vue-numeric-input
              ...
              <button class="btn btn-danger w-100 h-100">
                ...
                <span class="fa fa-angle-right ms-2"></span>
                        ...
                        ></ejs-slider>
                        <div class="d-flex justify-content-between">
                            <div v-if="day_range[0] == 1">
                                {{ day_range[0] }} Day
                            </div>
                            <div v-else>{{ day_range[0] }} Days</div>
                            <div v-if="day_range[1] == 30">
                                {{ day_range[1] }}+ Days
                            </div>
                ...
                <div class="col-lg-9 col-xs-12">
                    <section class="section-header">
                        ...
                        <span class="read-more"
                            >Tanzania is Africa’s number one safari destination.
                            The wildlife viewing is amazing and big cats are
                            easy to see. Africa Big Five can be found in many
                            Tanzanian parks and reserves.</span
                        >
                        ...
                        >
                            <span v-if="read_more" class="read-more">
                                The most famous parks are Ngorongoro Crater and
                                Serengeti National Park. More than a quarter of
                                the country is set aside for conservation.
                                Tanzania is also home to Africa tallest
                                Mountain, Mt. Kilimanjaro and has the best white
                                sand beaches at Zanzibar Island.</span
                            >
                        </transition>
                        <span
                            v-if="!read_more"
                    ...
                    <div class="mobile-sidebar-trigger mt-3 text-center">
                        ...
                        >
                            <span class="fa fa-filter me-2"></span> Search
                            Filter
                        </button>
                    </div>
                    <ul class="tagpill-group ps-0 mt-3">
                        <span
                            class="my-1"
                            v-if="
                                checked_specialized_filter_options.length !=
                                    0 ||
                                    checked_standard_filter_options.length !=
                                        0 ||
                                    day_range[0] != 1 ||
                                    day_range[1] != 30 ||
                        ...
                        >
                            <e-chips>
                                ...
                                <e-chip
                                    :text="item.title"
                                    v-for="(item,
                                    index) in checked_standard_filter_options"
                                    v-bind:key="index"
                                ></e-chip>
                                <e-chip
                                    :text="item.title"
                                    v-for="(item,
                                    index) in checked_specialized_filter_options"
                                    v-bind:key="index"
                                ></e-chip>
                                <e-chip
                                    v-if="
                    ...
                    <div
                        class="row gx-0"
                        v-else-if="
                            filterTours != null && filterTours.tours.length > 0
                        "
                    >
                        <div
                            class="col-md-6 col-xs-12"
...
// const TourCard = () =>
//     import(/* webpackChunkName: "TourCard" */ "../components/TourCard");
import TourCard from "../components/TourCard";
// const TourCardSkelecton = () =>
//     import(
//         /* webpackChunkName: "TourCardSkelecton" */ "../components/TourCardSkelecton"
//     );
import Vue from "vue";
    ...
    metaInfo() {
        return {
            ...
            meta: [
                ...
                {
                    property: "og:title",
                    content: "About Safari-Trek-Beach.com"
                },
                {
                    name: "twitter:title",
                    content: "About Safari-Trek-Beach.com"
        ...
        where_to_search: function() {
            if (this.where_to_search) {
                ...
                var start_filtered = this.search_result.filter(p =>
                    p.title
                        .toLowerCase()
                        .startsWith(this.where_to_search.toLowerCase())
                );
    ...
    methods: {
        async preProcess() {
            ...
            if (destination_url !== undefined && destination_url !== "") {
                ...
                if (destination_item != undefined) {
                    ...
                    if (single_url != "" && single_url != null) {
                        ...
                        let temp_destination = this.destination_id
                            .split("_")
                            .join(" ");
                        temp_destination = this.destination_id
                            .split("~")
                            .join("&");
                        temp_query = Object.assign(
            ...
            if (temp_query["comfort"] !== undefined) {
                temp_query["comfort"] = temp_query["comfort"]
                    .split("_")
                    .join(" ");
                temp_query["comfort"] = temp_query["comfort"]
                    .split("@")
            ...
            await this.$store
                ...
                .then(() => {
                    ...
                    for (var i = 0; i < ar.length; i++) {
                        if (
                            ar[i].title == "Serengeti National Park" ||
                            ar[i].title == "Mount Kilimanjaro" ||
                            ar[i].title == "Ngorongoro Crater" ||
                            ar[i].title == "Tarangire National Park" ||
                            ar[i].title == "Zanzibar" ||
                            ar[i].title == "Ruaha National Park"
                        ) {
                            ar.splice(i, 1);
                        }
                    }
        ...
        async getTourFocus() {
            await this.$store
                .dispatch("tourController/getTourFocus")
                .then(() => {
        ...
        async getTourLevel() {
            await this.$store
                .dispatch("tourController/getTourLevel")
                .then(() => {
        ...
        setCurrentCheck() {
            ...
            var group =
                this.query_instore["group"] !== undefined
                    ...
                    : "";
            var page =
                this.query_instore["p"] !== undefined
                    ? this.query_instore.p
                    : "";
            ...
            for (let i = 0; i < this.specialized_check_list.length; i++) {
                if (
                    focus_list.includes(this.specialized_check_list[i].input_id)
                ) {
        ...
        deleteFilterOption: function(e) {
            ...
            var check_last_string = e.data.text.substr(
                e.data.text.length - 5,
                5
            );
            var check_last_string_4 = e.data.text.substr(
                e.data.text.length - 4,
                4
            );
            if (lastChar == "$") {
        ...
        removeFilterOptionItem(item) {
            for (
                let i = 0;
                i < this.checked_standard_filter_options.length;
                i++
            ) {
            ...
            for (
                let i = 0;
                i < this.checked_specialized_filter_options.length;
                i++
            ) {
        ...
        async getFilterTours() {
            ...
            for (
                ...
                level_filter +=
                    this.checked_standard_filter_options[i].title + "|";
            }

            if (level_filter != "") {
                level_filter = level_filter.substring(
                    0,
                    level_filter.length - 1
                );
            }
            ...
            if (focus_for_url != "") {
                focus_for_url = focus_for_url.substring(
                    0,
                    focus_for_url.length - 1
                );
            }
            ...
            if (url_query["comfort"] !== undefined) {
                url_query["comfort"] = url_query["comfort"]
                    .split(" ")
                    .join("_");
                url_query["comfort"] = url_query["comfort"]
                    .split("+")
            ...
            let destination_params =
                url_query["destination"] != undefined
                    ? url_query["destination"]
                    : "";
            ...
            switch (true) {
                ...
                case comfort_number == 1:
                    ...
                    this.search_name =
                        query["comfort"] + " " + this.search_name;
            ...
            await this.$store
                ...
                .then(() => {
                    console.log("tag", this.filterTours);
                    this.current_ourtour_page = parseInt(this.filterTours.page);
                    document.title =
                        this.search_name +
                        " ( " +
                        this.filterTours.total_tours +
                        " Tours )";
