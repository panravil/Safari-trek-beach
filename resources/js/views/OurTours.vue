        ...
        <div class="row">
            ...
            isSidebar
              ...
              : '',
                ...
                <div class="position-relative d-flex justify-content-between align-items-center px-3" @click="isSidebar = false">
            ...
            isSidebar
                        ...
                        <div class="col-md-12 mobile-filter position-relative" v-click-outside-dropdown="closeWhereToDropDown">
                            <div class="bg-white h-100 align-items-center d-flex justify-content-between px-3 shadow-sm">
                                ...
                                <div class="w-100 px-2" @click="showWhereToDropdown(true)">
                                    <input v-model="where_to_search" autocomplete="off" placeholder="Where To" type="text" ref="whereTo" class="w-100" v-on:keyup.enter="searchEnter" />
                                </div>
                    ...
                    ">
                        ...
                        <div class="col-md-12 mobile-filter position-relative" v-click-outside-dropdown="closeTravelerDropdown">
                            <div class="bg-white w-100 h-100 align-items-center d-flex justify-content-between px-3 shadow-sm" @click="showTravelerDropdown">
                                ...
                                <div class="w-100 px-2">
                                    <input v-model="traveler_number" autocomplete="off" id="traveler_input" type="text" placeholder="Travelers" class="w-100" />
                                </div>
              ...
              <button class="btn btn-danger w-100 h-100">
                ...
                <span class="fa fa-angle-right ms-2"></span>
                    ...
                    <ejs-slider :min="10" :max="10000" :type="'Range'" v-model="price_range" :changed="getFilterTours"></ejs-slider>
                    ...
                    <ejs-slider :min="1" :max="30" :type="'Range'" v-model="day_range" :changed="getFilterTours"></ejs-slider>
                    <div class="d-flex justify-content-between">
