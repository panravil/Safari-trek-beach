        ...
        <div class="container">
            <section>
                ...
                <h3 class="text-center mt-5">
                    Safari Packages in Safari-Trek-Beach are offered by
                    individual tour operator and not Safari-Trek-Beach company.
                </h3>
                <h4 class="mt-3 text-center">
                    For questions about a specific tour, we recommend that you
                    contact tour operator directly.
                </h4>
                ...
                <h5 class="mt-3">
                    2. Then Click Get Free Quote button to contact.
                </h5>
                ...
                <div class="text-center mt-5">
                    <router-link
                        ...
                        :to="{ name: 'Our Tours' }"
                    >
                        Start Here <span class="fa fa-angle-right ms-2"></span
                    ></router-link>
                </div>
            </section>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="mt-5">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    >
                                        <span
                                            class="fa fa-phone-square me-2"
                                        ></span>
                                    </h5>
                                    <h5>
                                        <a href="tel:+255758022567"
                                            >+255 758 022 567</a
                                        >
                                    </h5>
                                </div>
                                <div class="d-flex align-items-center">
                                    ...
                                    >
                                        <span
                                            class="fa fa-envelope me-2"
                                        ></span>
                                    </h5>
                                    <h5>
                                        <a
                                            href="mailto:info@safari-trek-beach.com"
                                            >info@safari-trek-beach.com</a
                                        >
                                    </h5>
                                </div>
                            </div>
                            ...
                            <div class="row gx-0 d-flex py-4 align-item-center">
                                <div class="col-md-12 text-center">
                                    <a href="#" target="_blank"
                                        ><span
                                            class="fa fa-facebook-f fa-2x text-danger me-5"
                                        ></span
                                    ></a>
                                    <a href="#" target="_blank"
                                        ><span
                                            class="fa fa-instagram fa-2x text-danger me-5"
                                        ></span
                                    ></a>
                                    <a href="#" target="_blank"
                                        ><span
                                            class="fa fa-twitter fa-2x text-danger me-5"
                                        ></span
                                    ></a>
                                    <a href="#" target="_blank"
                                        ><span
                                            class="fa fa-youtube fa-2x text-danger"
                                        ></span
                                    ></a>
                                </div>
                            </div>
            ...
            meta: [
                {
                    name: "description",
                    content:
                        "Contact Safri-Trek-Beach.com info@safari-trek-beach.com"
                },
                {
                    property: "og:title",
                    content: "Contact Safari-Trek-Beach.com"
                },
                {
                    name: "twitter:title",
                    content: "Contact Safari-Trek-Beach.com"
            ...
            try {
                emailjs
                    ...
                    .then(() => {
                        ...
                        //     title: "Email Sent!",
                        //     text:
                        //         "Thank you! We have received your email. We will soon reply."
                        // });
                        this.$router.push("/thankyou-contact");
