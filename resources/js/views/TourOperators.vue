...
<div id="tour-operators-page">
    <div class="container">
        ...
        <div v-else>
            <div class="card p-3 mt-5 tour-operator-card" v-for="(operator, index) in current_page_operators" v-bind:key="'operator' + index" @click="toOperatorDetail(operator.user_id)">
                <div class="wrapper">
