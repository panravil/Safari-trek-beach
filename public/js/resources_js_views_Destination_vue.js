...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  created: function created() {
    if (this.page_id != '') this.current_destination_page = parseInt(this.page_id);else this.current_destination_page = 1;
  ...
  methods: {
    getListDestinations: function getListDestinations() {
      ...
      this.$store.dispatch("destinationController/getListDestinations").then(function () {
        _this2.getCurrentPageDestinations(_this2.current_destination_page);

        _this2.total_page_number = Math.floor(_this2.listDestinations.length / _this2.destinations_per_page);

        if (_this2.listDestinations.length % _this2.destinations_per_page > 0) {
          _this2.total_page_number = _this2.total_page_number + 1;
        }

        var page_title = "Safari-Trek-Beach Destination - Page " + _this2.current_destination_page + " of " + _this2.total_page_number;
